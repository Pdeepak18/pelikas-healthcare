  ...
  return (
    ...
    <>
      ...
      <div className="w-[100%] ">
        ...
        <section className="relative z-10 overflow-hidden smll bg-white py-20 px-3 ">
          <div className="container mx-auto">
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <span className="text-primary mb-4 block  text-xl font-semibold text-[#4063D6]">
                    Contact Us
                  </span>
                ...
                <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                  <form ref={form} onSubmit={sendEmail}>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="bg-[#3056D3] text-xl border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        Send Message
                      </button>
                    </div>
