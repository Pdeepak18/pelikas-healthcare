  ...
  return (
    <div className="bg-gradient-to-r from-slate-500 to-yellow-100 pt-24">
      <div className="max-w-7xl m-auto ">
        <div className="flex items-center space-x-20 pt-24 pr-20">
          <div>
            ...
            <p className="text-xl pt-10">
              Our business is built on the strength of our pharmaceuticals. Maya
              Biotech Pvt. Ltd. Takes great care to always provide
              pharmaceuticals of the highest quality that are manufactured using
              only natural ingredients. No additives, contaminants, or
              impurities are used in our products. Our quality assurance team is
              constantly on-site during manufacturing. By utilizing our
              ...
              providing the highest possible service standards to all members of
              society while upholding our core values of integrity, ethics, and
        ...
        <div className="flex items-center space-x-20 pt-24 pl-20">
        <img
            src={BgImage}
            alt="mission"
            width={500}
        ...
        <div className="flex items-center space-x-20 pt-24 pb-48 pr-20">
          <div>
            <h1 className=" text-blue-900 font-bold text-3xl"> MISSION </h1>
            <p className="text-xl pt-10">
              Our business is built on the strength of our pharmaceuticals. Maya
