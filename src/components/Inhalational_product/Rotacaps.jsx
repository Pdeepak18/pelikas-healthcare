...
const Rotacaps = () => {
    const data = Inhalational_Formulations.ROTACAPS;
    useEffect(() => {
      window.scrollTo(0, 0);
    }, []);
  return (
    ...
    <div className=" overflow-y-auto overflow-x-hidden">
      ...
      <div className="flex flex-col justify-center items-center text-center gap-10 px-[10px] md:px-auto">
        ...
        <p className=" md:max-w-[960px] max-w-700px m-auto  text-justify text-2xl font-bold">ROTACAPS </p>
      </div>
