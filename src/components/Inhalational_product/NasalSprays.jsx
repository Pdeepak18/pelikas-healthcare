...
import Inhalational_Formulations from "../../assests/JsonFile/Inhalational_Formulation.json";

const NasalSprays = () => {
    const data = Inhalational_Formulations["NASAL SPRAYS"];
    useEffect(() => {
      window.scrollTo(0, 0);
    }, []);
  return (
    ...
    <div className=" overflow-y-auto overflow-x-hidden">
      ...
      <div className="flex flex-col justify-center items-center text-center gap-10 px-[10px] md:px-auto">
        <h1 className="font-semibold text-3xl md:text-4xl text-green-600 underline italic uppercase" >
         INHALATIONAL FORMATION 
        </h1>
        <p className=" md:max-w-[960px] max-w-700px m-auto  text-justify text-2xl font-bold">{"NASAL SPRAYS"} </p>
      </div>
